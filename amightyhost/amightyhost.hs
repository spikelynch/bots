...
main :: IO ()
main = do   
  places <- loadOptions "places.txt"
  water <- loadOptions "waterways.txt"
  wadj <- loadOptions "water_adj.txt"
  animal <- loadOptions "animals_sing.txt"
  animals <- loadOptions "animals_plural.txt"
  weapons <- loadOptions "weapons.txt"
  heroes <- loadOptions "heroes.txt"
  hero_adj <- loadOptions "hero_adj.txt"
  hero_noun <- loadOptions "hero_noun.txt"
